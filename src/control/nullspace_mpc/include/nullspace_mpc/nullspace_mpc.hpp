...
{
    class MPC : public rclcpp::Node // MPC execution (dependent on ROS 2)
    {
        public:
            MPC();
            ~MPC();
        private:
            ...
            rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pub_mppi_via_state_sequence_;
