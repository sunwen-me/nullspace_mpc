...
#  define QSC_ERROR_STREAM(x) RCLCPP_ERROR_STREAM(rclcpp::get_logger("qp_solver_collection"), x)
#  define QSC_WARN_STREAM(x) RCLCPP_WARN_STREAM(rclcpp::get_logger("qp_solver_collection"), x)
#  define QSC_INFO_STREAM(x) RCLCPP_INFO_STREAM(rclcpp::get_logger("qp_solver_collection"), x)
#endif
